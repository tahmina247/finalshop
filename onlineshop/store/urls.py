...
urlpatterns = [
    ...
    path('users/<int:pk>/', UserProfileDetailViewSet.as_view({'get':'retrieve', 'put':'update',
    ...
    path('cart_item/', CarItemViewSet.as_view({'get':'list', 'post':'create'}), name='car_item_list'),
    path('car_item/<int:pk>/', CarItemViewSet.as_view({'put':'update', 'delete':'destroy'}))
]